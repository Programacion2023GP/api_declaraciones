...
class ControllerTiposAdeudos extends Controller
{
    public function show(Response $response)
    {
        ...
        try {
            $estado_civil = DB::table('TipoAdeudo')->select('valor as text', 'clave as id')->where('active', 1)->get();
    ...
    public function index(Response $response)
    {
        ...
        try {
            $regimen = DB::table('TipoAdeudo')->select('valor as text', 'clave as id')->where('active', 1)->orderBy('clave', 'desc')
                ->get();
    ...
    public function create(Response $response, Request $request)
    {
        ...
        try {
            $maximo_id = DB::table('TipoAdeudo')->max('clave');

            $regimen_matrimonial = DB::table('TipoAdeudo')->insertGetId([
                'clave' => $maximo_id + 1,
                'valor' => $request->valor,
            ]);
            ...
            // return "fff";
            $response->data = ObjResponse::CorrectResponse();
            $response->data["message"] = 'peticion satisfactoria | TIPO DE ADEUDOS guardado correctamente.';
            $response->data["alert_text"] = "regimenes encontrados";
    ...
    public function update(Response $response, Request $request, $id)
    {
        ...
        try {
            ...
            $response->data = ObjResponse::CorrectResponse();
            $response->data["message"] = 'Petición satisfactoria | TIPO DE ADEUDOS actualizado correctamente.';
    ...
    public function delete(Response $response, Request $request, $id)
    {
        ...
        try {
            ...
            $response->data = ObjResponse::CorrectResponse();
            $response->data["message"] = 'Petición satisfactoria | TIPO DE ADEUDOS eliminado correctamente.';
            $response->data["alert_text"] = "Regímenes encontrados";
            $response->data["result"] = $id; // Puedes devolver el ID del  TIPO DE ADEUDOS actualizado si lo necesitas
        } catch (\Exception $ex) {
            $erros = new ControllerErrors();

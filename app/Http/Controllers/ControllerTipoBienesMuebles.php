...
class ControllerTipoBienesMuebles extends Controller
{
    public function show(Response $response)
    {
        ...
        try {
            $estado_civil = DB::table('TipoBienBienesMuebles')->select('valor as text', 'clave as id')->where('active', 1)->get();
    ...
    public function index(Response $response)
    {
        ...
        try {
            $regimen = DB::table('TipoBienBienesMuebles')->select('valor as text', 'clave as id')->where('active', 1)->orderBy('clave', 'desc')
                ->get();
    ...
    public function create(Response $response, Request $request)
    {
        ...
        try {
            $maximo_id = DB::table('TipoBienBienesMuebles')->max('clave');

            $regimen_matrimonial = DB::table('TipoBienBienesMuebles')->insertGetId([
                'clave' => $maximo_id + 1,
                'valor' => $request->valor,
            ]);
            ...
            // return "fff";
            $response->data = ObjResponse::CorrectResponse();
            $response->data["message"] = 'peticion satisfactoria | TIPO DE BIENES MUEBLES guardado correctamente.';
            $response->data["alert_text"] = "regimenes encontrados";
    ...
    public function update(Response $response, Request $request, $id)
    {
        ...
        try {
            ...
            DB::table('TipoBienBienesMuebles')
                ->where('clave', $id)
                ->update([
                    'valor' => $request->valor,
                ]);
            ...
            $response->data = ObjResponse::CorrectResponse();
            $response->data["message"] = 'Petición satisfactoria | TIPO DE BIENES MUEBLES actualizado correctamente.';

...
class ControllerTomaDecisiones extends Controller
{
    ...
    public function index(Response $response, int $id)
    {
        ...
        try {
            $data = DB::table('DECL_ParticipacionTomaDecisiones') // Selecciona la tabla DECL_Datosgenerales
...

    {
        ...
        try {
            ...
            foreach ($request->all() as $datos) {
                ...
                unset($datos['Id_ParticipacionTomaDecisiones']);
            ...
            $response->data = ObjResponse::CorrectResponse();
            $response->data["message"] = 'Petición satisfactoria | PARTICIPA EN LA TOMA DE DECISIONES DE ALGUNA DE ESTAS INSTITUCIONES actualizadas correctamente.';

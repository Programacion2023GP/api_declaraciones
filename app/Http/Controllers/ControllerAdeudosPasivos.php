...
class ControllerAdeudosPasivos extends Controller
{
    public function create(Response $response, Request $request)
    {
        ...
        try {
            ...
            $response->data["message"] = 'Se insertaron los ADEUDOS PASIVOS.';
    ...
    public function index(Response $response, int $id)
    {
        ...
        try {
            $data = DB::table('DECL_AdeudosPasivos') // Selecciona la tabla DECL_Datosgenerales
...

    {
        ...
        try {
            ...
            $response->data = ObjResponse::CorrectResponse();
            $response->data["message"] = 'Petición satisfactoria | ADEUDOS PASIVOS actualizados correctamente.';
